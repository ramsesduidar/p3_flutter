  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        decoration: BoxDecoration(
          ...
          borderRadius:
              BorderRadius.circular(10), //Ajusta el radio según sea necesario
        ),
        child: const Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        decoration: BoxDecoration(
          ...
          borderRadius:
              BorderRadius.circular(5), //Ajusta el radio según sea necesario
        ),
        child: Padding(
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(
                      5), //Ajusta el radio según sea necesario
                ),
                child: Padding(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        ListTile(
                          ...
                          subtitle: const Text(
                            ...
                            maxLines:
                                2, // Establece el número máximo de líneas que deseas mostrar
                            overflow: TextOverflow
                                .ellipsis, // Opcional: agrega puntos suspensivos al final si el texto está truncado
                          ),
                        ),
                        Row(
