...
class MisCampeonatosPiloto extends StatelessWidget {
  const MisCampeonatosPiloto({super.key});

  @override
  Widget build(BuildContext context) {
    return MisCampeonatos();
  }
}

class MisCampeonatos extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
