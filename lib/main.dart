...
const ColorScheme myColorScheme = ColorScheme(
  ...
  surface:
      Color(0xFFFFFFFF), // Color de superficie (fondos de las aplicaciones)
  ...
  secondaryContainer: Color.fromARGB(255, 150, 209, 132),
);
      ...
      return Scaffold(
        appBar: AppBar(
          title: Text(
            ...
            style: TextStyle(
              color:
                  theme.colorScheme.onSecondary, // Color blanco para el texto
